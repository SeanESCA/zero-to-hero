...
![Each set of numbers in the table above is a subset of the set in the next row.
The natural numbers are a subset of the integers, which are themselves a subset 
of the rational numbers, and so on.](./img/types_of_numbers.jpeg)

Practice with your knowledge of sets with these questions:

{{< 
    numbas
    src="https://numbas.mathcentre.ac.uk/question/100368/sets-set-notation/embed/"
    style="max-height: 800px; aspect-ratio: 4/5;"
>}}
